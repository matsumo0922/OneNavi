...
buildkonfig {
    ...
    defaultConfigs {
        fun setField(
            ...
            buildConfigField(FieldSpec.Type.STRING, name, rawValue ?: defaultValue)
        }
        ...
        setField("SERVER_ROUTE_CF_ACCESS_CLIENT_ID", preferEnvironment = true)
        setField("SERVER_ROUTE_CF_ACCESS_CLIENT_SECRET", preferEnvironment = true)

...
internal data class RouteCandidateDto(
    ...
    val priority: RoutePriorityDto,
    val mergedFromPriorities: List<RoutePriorityDto>,
...
internal data class RouteCongestionSegmentDto(
    ...
    val startMeasureMetres: Double,
    val endMeasureMetres: Double,
    val level: RouteCongestionLevelDto,
    val source: String,
...
internal data class RouteIncidentDto(
    ...
    val startMeasureMetres: Double,
    val endMeasureMetres: Double,
    val category: RouteIncidentCategoryDto,
    val kind: RouteIncidentKindDto,
    val displayText: String? = null,
...
internal data class RouteDiagnosticDto(
    val level: RouteDiagnosticLevelDto,
    val message: String,

...
入力は `drive-supporter-api/analysis/sample/<sample-id>/extracted/` 以下の生
データ:
...
- 外部ルート polyline (青、5px)
- Routes API split polyline (chunk ごとに色相をずらした赤系、4px)
